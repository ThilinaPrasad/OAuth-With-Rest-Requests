package com.spring.oauth.oauthrest.config;

import com.spring.oauth.oauthrest.services.CustomAuthmanager;
import com.spring.oauth.oauthrest.services.CustomUserDetailsService;
...
public class AutherizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory().withClient("user").authorizedGrantTypes("client_credentials","password")
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        endpoints.authenticationManager(customAuthmanager);
    }
}
